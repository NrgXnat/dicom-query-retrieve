...
public class DqrDateRange extends DateRange{
    ...
    public DqrDateRange(Date start, Date end) {
        if (null == start) {
            start = MIN_DATE;
        }
        if (null == end) {
    ...
    public boolean includes(DqrDateRange arg) {
        return this.includes(arg.start) && this.includes(arg.end);
    }

    public boolean overlaps(DqrDateRange arg) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof DqrDateRange))
            return false;
        DqrDateRange other = (DqrDateRange) obj;
        if (end == null) {
            if (other.end != null)
                return false;
