 ...
 * @since Jan, 2006
 */
public class DcmQRXnat {
    private static final Logger LOG = LoggerFactory.getLogger(DcmQRXnat.class);
    ...
    private static CommandLine parse(String[] args) {
        ...
        if (cl.hasOption('V')) {
            Package p = DcmQRXnat.class.getPackage();
    ...
    public static void main(String[] args) {
        ...
        DcmQRXnat dcmqr = new DcmQRXnat(cl.hasOption("device")
    ...
    private final DimseRSPHandler rspHandler = new DimseRSPHandler() {
        ...
        public void onDimseRSP(Association as, DicomObject cmd,
                DicomObject data) {
            DcmQRXnat.this.onMoveRSP(as, cmd, data);
        }
    };
    ...
    private static InputStream openFileOrURL(String url) throws IOException {
        if (url.startsWith("resource:")) {
            return DcmQRXnat.class.getClassLoader().getResourceAsStream(
                    url.substring(9));
        }
        try {
