		...
		if(allRoles==null){
            ...
            if(propFiles!=null){
                for(final String props: propFiles) {
                    ...
                    final Map<String,Map<String,Object>> roles = RetrievePropertyObjects(props, PROP_OBJECT_IDENTIFIER, PROP_OBJECT_FIELDS);
			...
			try {
				List<Resource> list = BasicXnatResourceLocator.getResources("classpath*:META-INF/conf/roles/**/*-definition.properties");
				for(Resource res: list){
					final Map<String,Map<String,Object>> roles = RetrievePropertyObjects(res.getURL(), PROP_OBJECT_IDENTIFIER, PROP_OBJECT_FIELDS);
					for(Map<String,Object> role:roles.values()){
