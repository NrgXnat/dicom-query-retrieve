...
public interface SeriesRetrievalRequestService extends BaseHibernateService<SeriesRetrievalRequest> {
     ...
     */
    SeriesRetrievalRequest createFromCFindResult(UserI user, String destinationProject, DicomObject cfindResult);
     ...
     * @return List of series retrieval requests
     */
    List<SeriesRetrievalRequest> findReverseChronological(@Nullable UserI user, PaginatedPacsRequest request);
}
