...
public class StudyImportInformation {
    ...
    public boolean equals(Object o) {
        ...
        if (seriesDescriptions != null ? !seriesDescriptions.equals(info.seriesDescriptions) : info.seriesDescriptions != null) return false;
        if (anonScript != null ? !anonScript.equals(info.anonScript) : info.anonScript != null) return false;
