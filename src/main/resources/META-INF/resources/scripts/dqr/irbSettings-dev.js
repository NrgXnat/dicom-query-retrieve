/*
 * dicom-query-retrieve: irbSettings-dev.js
...
(function(factory){
    ...
    waitForElement(1, '#irb-number', function($el){
        ...
        $('#save-irb-number').on('click', function(e){
            ...
            var irbNumberValue = el.value;

            // var origEncode = XNAT.url.encode;
            // XNAT.url.encode = false;

            var URL = XNAT.url.restUrl(irbUrl, { irbNumber: el.value }, false);

            // XNAT.url.encode = origEncode;

            console.log(URL);

            var saveNumber = XNAT.xhr.put(URL, {});
